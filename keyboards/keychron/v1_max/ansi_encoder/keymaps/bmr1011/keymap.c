...
// mods to shorten names
#define CTL_ESC CTL_T(KC_ESC)
#define SPC_NAV LT(MAC_FN, KC_SPC)
#define HYPR_CAPS HYPR_T(KC_CAPS)
#define ALT_SCLN ALT_T(KC_SCLN)
#define MO_WIN MO(WIN_FN)
...
[MAC_BASE] = LAYOUT_ansi_82(
    ...
    CTL_ESC,       KC_A,     KC_S,          KC_D,       KC_F,       KC_G,       KC_H,               KC_J,       KC_K,       KC_L,            ALT_SCLN,        KC_QUOT,                KC_ENT,           KC_HOME,
    KC_LSFT,                 KC_Z,          KC_X,       KC_C,       KC_V,       KC_B,               KC_N,       KC_M,       KC_COMM,         KC_DOT,          KC_SLSH,                KC_RSFT, KC_UP,
    KC_LCTL,       KC_LOPTN, KC_LCMMD,                                          SPC_NAV,                                                     HYPR_CAPS,       KC_RALT,    MO_WIN,     KC_LEFT, KC_DOWN, KC_RGHT),
...
[MAC_FN] = LAYOUT_ansi_82(
    ...
    _______,       KC_ESC,   KC_MS_WH_UP,   G(KC_LBRC), G(KC_RBRC), KC_MS_UP,   KC_PAGE_UP,         KC_HOME,    KC_UP,      KC_END,          KC_DELETE,       _______,    _______,    _______,          _______,
    _______,       KC_LCTL,  KC_MS_WH_DOWN, KC_LSFT,    KC_LALT,    KC_MS_DOWN, KC_PAGE_DOWN,       KC_LEFT,    KC_DOWN,    KC_RIGHT,        KC_BSPC,         _______,                _______,          KC_END,
    _______,                 G(KC_Z),       G(KC_X),    G(KC_C),    KC_MS_BTN1, KC_MS_BTN3,         KC_MS_BTN2, KC_MS_LEFT, KC_MS_RIGHT,     _______,         _______,                _______, _______,
...
[WIN_BASE] = LAYOUT_ansi_82(
    ...
    KC_LSFT,                 KC_Z,          KC_X,       KC_C,       KC_V,       KC_B,               KC_N,       KC_M,       KC_COMM,         KC_DOT,          KC_SLSH,                KC_RSFT, KC_UP,
    KC_LCTL,       KC_LGUI,  KC_LALT,                                           KC_SPC,                                                      KC_RALT,         MO_WIN,     KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT),
